...
namespace WarriorGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(InputTag_UnqeuipAxe, "InputTag.UnqeuipAxe");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_LightAttack_Axe, "InputTag.LightAttack.Axe");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_HeavyAttack_Axe, "InputTag.HeavyAttack.Axe");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_Roll, "InputTag.Roll");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SwitchTarget, "InputTag.SwitchTarget");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWaponAbility_Light, "InputTag.SpecialWaponAbility.Light");
	UE_DEFINE_GAMEPLAY_TAG(InputTag_SpecialWaponAbility_Heavy, "InputTag.SpecialWaponAbility.Heavy");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_SpecialWaponAbility_Light, "Player.Ability.SpecialWaponAbility.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_SpecialWaponAbility_Heavy, "Player.Ability.SpecialWaponAbility.Heavy");
	UE_DEFINE_GAMEPLAY_TAG(Player_Ability_PickUp_Stones, "Player.Ability.PickUp.Stones");

	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWaponAbility_Light, "Player.Cooldown.SpecialWaponAbility.Light");
	UE_DEFINE_GAMEPLAY_TAG(Player_Cooldown_SpecialWaponAbility_Heavy, "Player.Cooldown.SpecialWaponAbility.Heavy");
	...
	UE_DEFINE_GAMEPLAY_TAG(Player_Status_Rage_Avtive, "Player.Status.Rage.Avtive");
	...
	UE_DEFINE_GAMEPLAY_TAG(Enemy_Status_Straifing, "Enemy.Status.Straifing");
