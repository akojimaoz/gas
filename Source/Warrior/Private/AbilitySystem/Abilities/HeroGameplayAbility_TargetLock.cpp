...
void UHeroGameplayAbility_TargetLock::OnTargetLockTick(float DeltaTime)
{
	if (!CurrentLockedActor || 
		...
		UWarriorFunctionLibrary::NativeDoesActorHaveTag(GetHeroCharacterFromActorInfo(), WarriorGameplayTags::Shared_Ability_Death)
		)
	{
	...
	if (bShouldOverrideRotation)
	{
		...
		const FRotator TargetRot = FMath::RInterpTo(CurrentControlRot, LookAtRot, DeltaTime, TaretLockRotationInterpSpeed);
...
void UHeroGameplayAbility_TargetLock::DrawTargetLockWidget()
{
	...
	{
		checkf(TargetLockWidgetClass, TEXT("Forgot to assign avlid widget class in blueprint"));
